    ...
    <div className="flex flex-col gap-6">
      <div className="grid gap-4 md:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="flex flex-col justify-center gap-3 rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-50 to-white p-5">
          ...
          <Image src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-09-04%20at%2022.37.00-4s3tJ6M0iKdT5g3yPthrwVeAdq96e9.jpeg" alt="Brian Peru in a formal portrait" width={1080} height={1080} className="mt-2 h-36 w-full rounded-xl object-contain bg-gray-100 shadow-sm" />
        </div>
      </div>
