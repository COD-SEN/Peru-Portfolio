...
function DocxViewer({ url }: { url: string }) {
  ...
  return error ? <PreviewError onRetry={() => setError(false)} /> : <div ref={ref} className="docx-viewer h-full min-w-0 w-full overflow-auto bg-slate-200 p-1.5 sm:p-4" />
}
