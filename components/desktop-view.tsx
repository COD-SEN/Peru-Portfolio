...
export function DesktopView({ onRestart, onLogout }: DesktopViewProps) {
  ...
  useEffect(() => {
    const preloadSections = () => {
      void Promise.all([
        import("@/components/windows/profile-content"),
        import("@/components/windows/projects-content"),
        import("@/components/windows/resume-content"),
        import("@/components/windows/socials-content"),
        import("@/components/windows/interests-content"),
        import("@/components/windows/ambitions-content"),
        import("@/components/windows/contact-content"),
        import("@/components/windows/documents-content"),
      ])
    }
    ...
    const timer = window.setTimeout(preloadSections, 100)
